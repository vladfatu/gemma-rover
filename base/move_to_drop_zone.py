...
#     if decoded_objects:
#         print("Decoded QR code with pyzbar")
#         print("Decoded data:", decoded_objects)
#     else:
#         print("No QR code detected with pyzbar.")

#     detector = cv2.QRCodeDetector()
#     data, bbox, _ = detector.detectAndDecode(preprocessed_image)
...
#         width = get_distance(bbox[0], bbox[2])
#         ideal_width = 300
#         print("width:", width)
#         if abs(width - ideal_width) < 10:
#             x_vel = 0.0
#         else:
